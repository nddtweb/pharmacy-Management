					...
					<div class="row">
						<div class="col-md-7 col-lg-6 ">
							<div class="detail-box">
								...
								<p>Our Pharmacy Management System revolutionizes the way pharmacies operate, offering a seamless platform for managing inventory, prescriptions, and customer interactions. Say goodbye to manual processes and hello to streamlined operations that save time and reduce errors.</p>
								<div class="btn-box">
									<a href="product.jsp" class="btn1"> Shop Now </a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-7 col-lg-6 ">
							<div class="detail-box">
								...
								<p>With our Pharmacy Management System, you get a comprehensive suite of tools designed to handle every aspect of pharmacy management. From inventory control and prescription tracking to customer management and sales analytics, our system empowers pharmacies to operate efficiently and profitably.</p>
								<div class="btn-box">
									<a href="product.jsp" class="btn1"> Shop Now </a>
								</div>
							</div>
...
<section class="product_section layout_padding">
	<div class="container">
		...
		<div class="btn-box">
			<a href="product.jsp"> View All products </a>
		</div>
	</div>
</section>
<!-- end product section -->
